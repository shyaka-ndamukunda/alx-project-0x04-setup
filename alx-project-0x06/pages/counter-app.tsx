...
import { useSelector } from "react-redux"; // Import useSelector to read state
import { RootState, useAppDispatch, increment, decrement } from "@/store/store"; // Import Redux types and actions
